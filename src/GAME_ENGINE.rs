...
// use crate::MAP::Map;
// use crate::MULTIMEDIA::{Assets, RenderParams, WindowParams};
...
//         let assets = Assets::GetFirstTexture(&sdlTextureCreator);
//
//         Self {
//             sdlContexts,
//             sdlCanvas,
...
//                     //self.sdlCanvas.copy(&tempTexture, Rect::new((rayCursor.GetWidthPercent() as f64 * 64.0) as i32, 0, 1, 64),Rect::new(x as i32, y, 1, renderHeight as u32));
//                     break;
//                 }
//             }
//         }
